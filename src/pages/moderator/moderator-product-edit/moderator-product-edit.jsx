...
const ModeratorProductEditContainer = ({ className, products, setProducts }) => {
			...
			<div className="page-shell">
				...
				<form className="product-form" onSubmit={handleSubmit}>
					...
					<div className="field-row">
						...
						<label>
							<span>Статус</span>
							<select defaultValue="Обычный">
								<option>Обычный</option>
								<option>Лучший</option>
...
export const ModeratorProductEdit = styled(ModeratorProductEditContainer)`
